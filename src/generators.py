...
def card_number_generator(number_begin: [str], number_end: [str]) -> Generator[str, Any, None]:
    """
    ...
    """
    if (isinstance(number_begin, str) and number_begin.isdigit() and 0 < int(number_begin) <= 9999999999999999
          and isinstance(number_end, str) and number_end.isdigit() and 0 < int(number_end) <= 9999999999999999
          and int(number_end) >= int(number_begin) and len(number_begin) == 16 and len(number_end) == 16):
                number_begin = int(number_begin)
